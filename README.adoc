...
One could favor the alternative engineering notation, in which the exponent must always be divisible by 3 for easy conversion to the thousand / million / ... system.
