...
RuboCop already covers a significant portion of the guide and has [plugins](http://docs.rubocop.org/en/stable/integration_with_other_tools/) for most popular Ruby editors and IDEs.
